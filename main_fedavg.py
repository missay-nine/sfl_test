...
#python main_fedavg.py -m mlp -d mnist -R 100 -K 5 -M 50 -P 5 --partition exdir --alpha 1 10 --lr 0.1 --batch-size 20 --seed 1234 --clip 10 --eval-num 100 --device 0 --save-model 0
